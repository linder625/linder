...
layui.define(['admin', 'table', 'util'], function(exports){
  ...
  table.render({
    ...
    ,url: layui.setter.base + 'data/message/all.json' //模拟接口
    ,page: true
    ,cols: [[
  ...
  table.render({
    ...
    ,url: layui.setter.base + 'data/message/notice.json' //模拟接口
    ,page: true
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field: 'title', title: '标题内容', minWidth: 300, templet: tplTitle}
  ...
  table.render({
    ...
    ,url: layui.setter.base + 'data/message/direct.json' //模拟接口
    ,page: true
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field: 'title', title: '标题内容', minWidth: 300, templet: tplTitle}
