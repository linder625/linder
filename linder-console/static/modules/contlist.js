...
layui.define(['table', 'form'], function(exports){
  ...
  table.render({
    ...
    ,url: layui.setter.base + 'data/content/list.json' //模拟接口
    ,cols: [[
  ...
  table.render({
    ...
    ,url: layui.setter.base + 'data/content/tags.json' //模拟接口
    ,cols: [[
  ...
  table.render({
    ...
    ,url: layui.setter.base + 'data/content/comment.json' //模拟接口
    ,cols: [[
      {type: 'checkbox', fixed: 'left'}
      ,{field: 'id', width: 100, title: 'ID', sort: true}
